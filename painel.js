...
async function carregarDados(uid) {
  ...
  if (snap.exists()) {
    ...
    document.getElementById("interesses").value = (dados.interesses || []).join(', ');
    document.getElementById("disponibilidade").value = dados.disponibilidade || "";
...
form.addEventListener("submit", async (e) => {
  ...
  const data = {
    ...
    interesses: document.getElementById("interesses").value.split(',').map(i => i.trim()),
